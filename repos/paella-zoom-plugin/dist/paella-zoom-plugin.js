...
mt.INFO;
const gt = "@asicupv/paella-zoom-plugin", ft = "2.0.0", vt = "A plugin to zoom videos for Paella Player", yt = { ".": "./dist/paella-zoom-plugin.js", "./src/": "./src/" }, bt = "./dist/paella-zoom-plugin.js", _t = "module", Ct = "./dist/paella-zoom-plugin.js", Pt = ["dist/paella-zoom-plugin.js", "dist/paella-zoom-plugin.js.map", "dist/paella-zoom-plugin.umd.cjs", "dist/paella-zoom-plugin.umd.cjs.map"], It = { dev: "vite build --watch", build: "vite build --emptyOutDir" }, wt = { type: "git", url: "git+https://github.com/polimediaupv/paella-zoom-plugin.git" }, Lt = ["paella", "player", "zoom", "slide", "presentation", "blackboard", "whiteboard"], zt = "Fernando Serrano Carpena <ferserc1@gmail.com>", Tt = "SEE LICENSE IN license.txt", Zt = { url: "https://github.com/polimediaupv/paella-zoom-plugin/issues" }, Et = "https://github.com/polimediaupv/paella-zoom-plugin#readme", St = { vite: "^6.0.11" }, Mt = { "@asicupv/paella-core": "^2.0.0" }, D = {
  name: gt,
  version: ft,
  description: vt,
  exports: yt,
