...
export default class RelatedDocumentsPlugin extends PopUpButtonPlugin<RelatedDocumentsPluginconfig> {    
    ...
    async getContent() {
        ...
        const updateDisplay = async (index: number) => {
            ...
            const contentAIInfoHtml = `<div class="ai-generated-alert">
                <strong>${this.player.translate('Warning!')}</strong>
                <br/>
                ${this.player.translate('This content was generated by artificial intelligence.')} 
                ${this.player.translate('It has not been reviewed and may contain inaccuracies.')}
                <br/>
                ${this.player.translate('Please interpret it with caution.')}
            </div>`;
            ...
            display.innerHTML = `
                ${data.aiGenerated ? contentAIInfoHtml : ''}                
                ${data.media?.url ? `
                    <video 
                        controls 
                        src="${data.media.url}" 
