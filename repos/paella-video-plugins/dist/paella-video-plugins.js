...
const Xe = "@asicupv/paella-video-plugins", Ye = "2.0.2", Ke = { ".": "./dist/paella-video-plugins.js", "./paella-video-plugins.css": "./dist/paella-video-plugins.css", "./src/": "./src/" }, Ze = "More video formats for Paella Player", Je = "./dist/paella-video-plugins.js", et = "module", tt = "./dist/paella-video-plugins.js", it = ["dist/paella-video-plugins.css", "dist/paella-video-plugins.js", "dist/paella-video-plugins.js.map", "dist/paella-video-plugins.umd.cjs", "dist/paella-video-plugins.umd.cjs.map", "dist/hls*"], st = { dev: "vite", build: "vite build --emptyOutDir" }, nt = { type: "git", url: "git+https://github.com/polimediaupv/paella-player.git" }, at = ["paella", "player", "zoom", "slide", "presentation", "blackboard", "whiteboard", "hls"], rt = "Fernando Serrano Carpena <ferserc1@gmail.com>", ot = "SEE LICENSE IN license.txt", lt = { url: "https://github.com/polimediaupv/paella-video-plugins/issues" }, ut = "https://github.com/polimediaupv/paella-video-plugins#readme", dt = { vite: "^6.0.11" }, ct = { "hls.js": "^1.5.20", "@asicupv/paella-core": "^2.0.3" }, ht = {
  name: Xe,
  version: Ye,
  exports: Ke,
  description: Ze,
